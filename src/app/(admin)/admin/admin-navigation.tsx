...
import { Home, ListOrdered, Wallet } from "lucide-react"; // ShieldCheck is no longer needed
      ...
      <aside className="fixed inset-y-0 left-0 z-10 hidden w-60 flex-col border-r bg-background sm:flex">
        <div className="flex h-16 items-center border-b px-6">
          <Link href="/admin/dashboard" className="flex items-center gap-2 font-semibold text-primary">
            {/* --- USE THE IMAGE COMPONENT INSTEAD OF THE ICON --- */}
            <Image 
              src="/apple-touch-icon.png" // Using one of the generated icons
              alt="Derivify Logo"
              width={24}
              height={24}
            />
